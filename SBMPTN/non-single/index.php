...
<!--
    ********************************************************
    Fake Generator - Pengumuman SBMPTN LTMPTN 2021
    Author: @naufalist //https://github.com/naufalist/sbmptn
    Original Source Code: Tim TIK LTMPT 2021
    ********************************************************
-->
<!DOCTYPE html>
<html lang="id">
<head>
	...
	<title>Pengumuman SBMPTN LTMPT 2021</title>
	<meta charset="utf-8">
    ...
    <div class="container" id="main" style="display: block;">
		...
		<div class="row m-1">
			<div class="col-12 text-center">
				<span class="title">PENGUMUMAN HASIL SELEKSI SBMPTN LTMPT 2021</span>
			</div>
		</div>
		<div class="void"></div>
...
?>
		...
		<p class="text-center"><small class="text-muted">&copy; 2021. <b>Bukan</b> Lembaga Tes Masuk Perguruan Tinggi</small></p>
				...
				<div class="row">
					...
					<div class="col-12 col-sm-8">
						<div class="container" style="background-color: #f8f8f8; padding:15px;">
							...
							<div class="row">
								<div class="col-12">
									<span style="font-size: 1.1em;">Selamat! Anda dinyatakan lulus seleksi SBMPTN LTMPT 2021 di</span>
								</div>
							</div>
							<div class="row no-gutters">
								<div class="col-auto col-sm-3">
							...
							<div class="row">
								<div class="col-12">
									<span>Anda dapat mencetak kembali Kartu Tanda Peserta UTBK-SBMPTN 2021 di <a target="_blank" href="https://portal.ltmpt.ac.id">sini</a>.</span>
	...
	<div class="container" id="not-accepted" style="display: none;">
		...
		<div class="row m-1">
			<div class="col-12 text-center">
				<span class="title">PENGUMUMAN HASIL SELEKSI SBMPTN 2021</span>
			</div>
		</div>
		<div class="void"></div>
		<div class="card card-block bg-faded mx-auto">
			<div class="card-body">
				<p class="text-center" style="font-size: 1em;">
					PESERTA ATAS NAMA <strong><span id="nama-peserta-tidak-terima"></span></strong> DENGAN NOMOR PESERTA <strong><span id="no-peserta-tidak-diterima"></span></strong> DINYATAKAN <strong>TIDAK DITERIMA</strong> PADA SBMPTN LTMPT 2021.
				</p>
	...
	<!-- footer class="footer">
      <div class="container">
        <p class="text-muted text-center">Panitia Pusat SBMPTN 2021</p>
      </div>
    </footer -->
