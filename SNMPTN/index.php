...
<head>
    ...
    <title>Hasil Seleksi SNMPTN 2021</title>
...
<body>
        ...
        <div class="navbar navbar-default navbar-static-top">
            <div class="container" style="padding-top: 10px;">
                <div class="navbar-header">
                    <span id="span1" class="h2">FAKE GENERATOR <a class="snmptn" href="http://www.snmptn.ac.id/">SNMPTN 2021</a></span>
                    <span id="span2" class="h2 hidden">HASIL SELEKSI <a class="snmptn" href="http://www.snmptn.ac.id/">SNMPTN 2021</a></span>
                </div>
            </div>
        </div>
        <div class="container">
            ...
            <p>
                ...
                Pengumuman Hasil Seleksi SNMPTN 2021 (PDF)
                </a>
            </p>
            <div class="alert alert-warning">
                Jadwal pencetakan ulang kartu pendaftaran: 10 April 2021 - 10 Mei 2021.
            </div>
            ...
            <div class="alert alert-success hidden" id="divResult">
                <table style="width: 100%">
                    <tbody><tr>
                        <td>
                            <p><strong>Selamat, Anda dinyatakan Lulus Seleksi SNMPTN 2021 pada</strong></p>
            ...
            <div class="alert alert-warning hidden" id="divInfoResult1">
                ...
                <p>
                    Pengumuman Resmi Tim Pelaksana Lembaga Tes Masuk Perguruan Tinggi 2021, <a href="#">klik disini</a>.
                </p>
                -->
                <!-- text 2018
                <p>Status penerimaan Anda sebagai mahasiswa di PTN tujuan, akan ditentukan berdasarkan verifikasi data akademik
                    ...
                    tanggal 8 Mei 2021 menentukan proses verifikasi dan status penerimaan Anda. Setelah Anda dinyatakan
                ...
                <p>Pengumuman Resmi Panitia Pusat Seleksi Nasional PMB PTN 2021, <a href="http://pengumuman.snmptn.ac.id/pengumuman2019.pdf">klik disini</a>.</p>
                -->
            </div>
            ...
            <div class="alert alert-danger hidden" id="divNotAccepted">
                Anda dinyatakan tidak lulus seleksi SNMPTN 2021. Silakan mengikuti SBMPTN 2021.
            </div>
    ...
    <div id="footer">
        <div class="container">
            <p id="foot1" class="muted">naufalist@2021</p>
            <p id="foot2" class="muted hidden">Tim Pelaksana Lembaga Tes Masuk Perguruan Tinggi 2021</p>
