...
<body>
        ...
        <div class="navbar navbar-default navbar-static-top">
            <div class="container" style="padding-top: 10px;">
                <div class="navbar-header">
                    <span class="h2"><a class="snmptn" href="http://www.snmptn.ac.id/">SNMPTN 2021</a> FAKE GENERATOR </span>
                </div>
            </div>
        </div>
        <div class="container">
    ...
    <div id="footer">
        <div class="container">
            <p class="muted"><strike>Tim Pelaksana Lembaga Tes Masuk Perguruan Tinggi 2021</strike></p>
        </div>
    </div>
